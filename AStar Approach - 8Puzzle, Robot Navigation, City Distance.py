...
class Robot():
    ...
    new_nav_map = [
          ...
          [7, 7, Fore.BLACK+'#', Fore.BLACK+'#', Fore.BLACK+'#', Fore.BLACK+'#', Fore.BLACK+'#', Fore.BLACK+'#', Fore.BLACK+'#', Fore.BLACK+'#', 5],
          [9, 9, 9, 9, 9, 9, 9, 11, 4, 5, 6],
    ]
    position = [startx, starty]
    queue.append((new_nav_map[starty][startx], position))
